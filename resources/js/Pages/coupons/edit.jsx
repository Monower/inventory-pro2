...
const CouponEdit = ({ coupon }) => {
    const { data, setData, put, processing, errors, transform } = useForm({
        ...
        starts_at: toInputDateTime(coupon.starts_at),
    ...
    return (
        <AuthenticatedLayout title="Edit Coupon">
            <section className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h3 className="heading">Edit Coupon</h3>
                        <p className="text-sm text-muted-foreground">
                            Update coupon rules without affecting order history.
                        </p>
                    </div>
