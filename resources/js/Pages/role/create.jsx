            ...
            <section>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-600 dark:text-slate-300">
                                Set a role name, then choose the permissions this
                                role should receive.
                            </p>
                        </div>
                    </div>
                ...
                <form onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-4">
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                                ...
                                <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                                    ...
                                    `manager`, `cashier`, or `inventory supervisor`.
                                </p>
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-slate-900 p-5 text-slate-50 shadow-sm dark:border-slate-700 dark:bg-slate-950">
                                ...
                                <p className="mt-1 text-sm text-slate-300 dark:text-slate-400">
                                    The permissions you select here will be granted
                                    immediately to this role after saving.
                                </p>
                        ...
                        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                            <div className="mb-5 flex flex-col gap-4 border-b border-slate-200 pb-4 dark:border-slate-700 lg:flex-row lg:items-end lg:justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-600 dark:text-slate-300">
                                        Search permissions, toggle all, or choose by
                                        section.
                                    </p>
                                </div>
                    ...
                    <div className="mt-6 flex justify-end">
                        <button
                            type="submit"
                            className="create-button px-6 py-2.5"
                        >
                            Save
                        </button>
                    </div>
