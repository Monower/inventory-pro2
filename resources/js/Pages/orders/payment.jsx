...
const Payment = ({ order, banks }) => {
    ...
    return (
        <AuthenticatedLayout title="Collect Order Payment">
            <section>
                <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="heading">Collect payment for {order.order_number}</h3>
                    </div>
                    <div className="text-sm text-muted-foreground">
                        Outstanding amount: {Number(order.due_amount).toFixed(2)}
                    </div>
                </div>
                ...
                <div className="mb-6 grid gap-4 rounded-lg border border-ring bg-background p-4 shadow-md md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <p className="font-medium">{Number(order.due_amount).toFixed(2)}</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="lg:col-span-2">
                            <fieldset className="custom-fieldset">
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    placeholder="Optional internal note for this payment"
                                />
                            </fieldset>
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        >
                            {processing ? "Saving..." : "Collect payment"}
                        </button>
                    </div>
                </form>
            </section>
