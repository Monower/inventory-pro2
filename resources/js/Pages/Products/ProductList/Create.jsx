...
export default function Create({ categories = [], units = [], attributes = [] }) {
                                        ...
                                        <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                                            ...
                                            <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                                                ...
                                                {data.variants.length === 0 && (
                                                    <tr>
                                                        <td colSpan={7} className="px-3 py-6 text-sm text-slate-500 dark:text-slate-400">No variants generated yet.</td>
                                                    </tr>
                                                )}
                                            </tbody>
                                        </table>
