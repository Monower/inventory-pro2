        ...
        <div className="sidebar bg-white shadow-md flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto py-4 px-2">
                <div className="space-y-1">
                    ...
                    <Link href="/dashboard" className="sidebar-link active flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('dashboard', this)">
                        <i className="fas fa-tachometer-alt text-gray-500 w-6 mr-3"></i>
                        <span className="sidebar-text">Dashboard</span>
                    </Link>
                    <Link href="/products" className="sidebar-link active flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('dashboard', this)">
                        <i className="fas fa-tachometer-alt text-gray-500 w-6 mr-3"></i>
