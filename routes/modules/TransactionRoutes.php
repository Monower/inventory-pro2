...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/transactions/export/excel', [TransactionController::class, 'exportExcel'])->name('transactions.export.excel')->middleware('permission:view transaction');
    ...
    Route::get('/transaction/show/{transaction_id}', [TransactionController::class, 'show'])->name('transaction.show')->middleware('permission:view transaction');
